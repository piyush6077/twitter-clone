...
const Post = ({ post }) => {
	...
	const { mutate: likedPost ,isPending: isLiking} = useMutation({
		...
		onSuccess: (updatedLikes)=>{
			// user experince point of view worst solution 
			// as it will fetch all post and reload/rerender we will done 
			// queryClient.invalidateQueries({ queryKey: ["posts"]})
	...
	const { mutate: commentUploaded ,isPending: isCommenting} = useMutation({
		mutationFn: async() => {
			try {
